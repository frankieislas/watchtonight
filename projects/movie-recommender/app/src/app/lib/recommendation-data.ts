...
export const movieCatalog: MoviePick[] = [
  ...
  },
  {
    ...
    year: 2018,
    service: "Netflix",
    fit: "A high-energy animated pick that still feels genuinely inventive and cool.",
    vibe: "Vibrant, funny, kinetic",
    whyTonight: "Best when you want something fast, stylish, and easy to love without feeling disposable.",
    fallbackReason: "A strong upbeat fallback when you want fun with real craft behind it.",
    intensity: "medium",
    runtime: 117,
    ...
    goodFor: ["stylish fun night", "easy crowd-pleaser"],
  },
  {
    title: "Palm Springs",
    year: 2020,
  ...
  },
  {
    ...
    year: 2014,
    service: "Max",
    fit: "A smart, clean action-sci-fi pick with real momentum and almost no drag.",
    vibe: "Sharp, propulsive, satisfying",
    whyTonight: "Best when you want action that feels clever instead of noisy.",
    fallbackReason: "A strong action fallback when you want something energetic but not sloppy.",
    intensity: "medium",
    runtime: 113,
    genres: ["Action", "Sci-fi"],
    moods: ["Fun", "Tense", "Thoughtful"],
    ...
    rewatchable: true,
    conversationStarter: false,
    goodFor: ["smart action night", "want momentum without slop"],
  },
  {
  ...
  },
  {
    ...
    year: 2016,
    service: "Prime Video",
    fit: "A warm, charming music-driven coming-of-age pick with a real lift to it.",
    vibe: "Warm, funny, hopeful",
    whyTonight: "Best when you want something earnest, human, and quietly energizing.",
    fallbackReason: "A softer uplifting fallback when thrillers feel like the wrong call.",
    intensity: "low",
    runtime: 106,
    genres: ["Comedy", "Romance", "Drama"],
    moods: ["Easy watch", "Fun", "Thoughtful"],
    avoidTags: ["too silly"],
    energy: "Low",
    tone: "light",
    complexity: "easy",
    ...
    rewatchable: true,
    conversationStarter: false,
    goodFor: ["uplifting watch", "want something heartfelt"],
  },
  {
  ...
  },
  {
    ...
    year: 1996,
    service: "Paramount+",
    fit: "A sharp, fun horror pick when you want tension without total misery.",
    vibe: "Meta, tense, playful",
    whyTonight: "Best when you want horror that is clever, energetic, and easy to watch with people.",
    fallbackReason: "A strong horror fallback when you want something dark but still fun.",
    intensity: "medium",
    runtime: 111,
    genres: ["Horror", "Thriller"],
    moods: ["Dark", "Fun", "Tense"],
    avoidTags: ["too intense"],
    energy: "Medium",
    tone: "balanced",
    complexity: "easy",
    ...
    rewatchable: true,
    conversationStarter: false,
    goodFor: ["group horror night", "want dark but fun"],
  },
  {
    title: "Gone Girl",
    year: 2014,
  ...
  },
  {
    ...
    year: 2022,
    service: "Peacock",
    fit: "A brutal mythic revenge movie when you want something dark and committed.",
    vibe: "Heavy, primal, intense",
    whyTonight: "Best when you want a serious, full-bodied dark watch and not something casual.",
    fallbackReason: "A heavier Peacock fallback when you want intensity instead of charm.",
    intensity: "high",
    runtime: 137,
    ...
    rewatchable: false,
    conversationStarter: true,
    goodFor: ["dark epic mood", "serious committed watch"],
  },
  {
    title: "The Babadook",
    year: 2014,
  ...
  },
  {
    ...
    year: 2024,
    service: "Apple TV+",
    fit: "An easy crime-comedy choice when you want something breezy and watchable.",
    vibe: "Loose, funny, low-stakes",
    whyTonight: "Best when you want a casual entertaining watch and do not want to work too hard.",
    fallbackReason: "A service-specific fallback when you want something lighter on Apple TV+.",
    intensity: "low",
    runtime: 101,
    genres: ["Comedy", "Crime", "Action"],
    moods: ["Easy watch", "Fun"],
    ...
    rewatchable: false,
    conversationStarter: false,
    goodFor: ["casual watch", "service-limited night"],
  },
  {
    title: "Prey",
    year: 2022,
  ...
  },
  {
    ...
    year: 2014,
    service: "Disney+",
    fit: "A funny, high-energy blockbuster when you want something easy and upbeat.",
    vibe: "Funny, colorful, energetic",
    whyTonight: "Best when you want a crowd-friendly action pick that does not feel heavy.",
    fallbackReason: "A dependable Disney+ fallback for a fun, low-friction night.",
    intensity: "medium",
    runtime: 121,
    genres: ["Action", "Comedy", "Sci-fi"],
    moods: ["Fun", "Easy watch"],
    ...
    rewatchable: true,
    conversationStarter: false,
    goodFor: ["crowd-pleaser", "fun easy blockbuster"],
  },
  {
    title: "Paddington 2",
    year: 2017,
